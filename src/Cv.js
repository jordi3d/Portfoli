  ...
  return (
    <div className="cv">
      <header>
        ...
        <div id="fotoMain">
          <div id="texte">
            foto de perfil, amb una animació que va canviant - la segons
            temàtica:
            <br />
            -(APD, Huawei, NEOM)
            <br />
      ...
      <section>
        ...
        <figure>
          ...
          />
          <figcaption>
            Unitat mòbil 3 D de Medialuso.Klepth Live 3 D al Palacio da Música
            de Porto{" "}
          </figcaption>{" "}
        </figure>{" "}
        <figure>
        ...
        <h2> -{feines[1][language]} </h2> <h3> --NEOM The Line 2020 </h3>{" "}
        <h3> --TZoH v2 2020 </h3> <h3> --Messi 10 by Cirque du Soleil 2019 </h3>{" "}
        <h3> --BTS Woody Allen 's visit to Spain 2019</h3>{" "}
        <h3> --NEOM Tourism Book & amp; Map 2019 </h3>{" "}
        <h3> --NEOM Immersive 2019 </h3> <h3> --NEOM Smart City 2019 </h3>{" "}
        <h3> --Messi Experience Park 2018 </h3> <h3> --VR Live 2018 </h3>{" "}
        <h3> --AutomaticTV 2014 </h3> <h3> --Immersive TV 2010 </h3>{" "}
        <h3> --Project FINE 2010 </h3> <h3> --Fútbol 3 D 2010 </h3>{" "}
        <h3> --2020 3 D Media 2008 </h3> <h3> --i3media 2008 </h3>{" "}
        <h3> --IPRacine 2008 </h3> <h2> -{feines[2][language]} </h2>{" "}
        <h2> -{feines[3][language]} </h2>{" "}
        <h3> --ESADE Mentor alumnes del Màster </h3> <h3> --La Salle </h3>{" "}
        <h3> --ERAM </h3> <h3> --MSc UPC </h3> <h3> --Mediapro AutomaticTV </h3>{" "}
        <h3> --Mediapro 3 D </h3> <h3> --RTVE Catalunya </h3> <h3> --ESCAC </h3>{" "}
        <h2> -VFX SV </h2> <h3> --Glory Day </h3>{" "}
        <h3> --Capçalera Festival de Sitges </h3>{" "}
        <h3> --Anunci Catalunya Música </h3> <h3> --Anunci La Agenda </h3>{" "}
        ...
        <h3>
          {" "}
          -Serveis de formació CGI, 3 D, XR, web, Presentacions en públic{" "}
        </h3>{" "}
        <h3> -SEO, SEM, Optimització de webs </h3> <h3> -crypto mining </h3>{" "}
      ...
      <section>
        <h2> +{titolsH2[1][language]} </h2> <h3> -VR </h3>{" "}
        <h3> -3 D als Matins de Catradio </h3>{" "}
        <h3> -Canal + Estrena simultània </h3> <h3> -TV3 Telenotícies </h3>{" "}
        <h3> -CadenaSER @cine.com </h3>{" "}
        <h3> -CATRADIO internet video @cine.com </h3>{" "}
        <h3> -internet video @cine.com </h3> <h3> -e - commerce @reg2.net </h3>{" "}
      </section>{" "}
      <section>
        <h2> +{titolsH2[2][language]} </h2> <h3> -Blog Veni Vidi Vici </h3>{" "}
        <h3> -Blog cine3D.com </h3> <h3> -Blog cine.com </h3>{" "}
        <figure>
          <img
      ...
      <section>
        ...
        <h3> -GITEX Huawei 5 G Keynote </h3>{" "}
        <h3> -La Liga Technology Showcase Shanghai </h3>{" "}
        <h3> -La Liga Technology Showcase BCN </h3>{" "}
        <h3> -COEIC media & amp; IT </h3>{" "}
        <h3> -Auditori Mediapro 2020 3 D Media </h3>{" "}
        <h3> -IBC 2020 3 D Media </h3> <h3> -CGIx Glory Day </h3>{" "}
        <figure>
          <img
            src="./img/CGIx.jpg"
          ...
          />
          <figcaption>
            Presentació del projecte "Glory Day" al CGIx de Barcelona 04 - 02 -
            1999{" "}
          </figcaption>{" "}
        </figure>{" "}
      ...
      <section>
        <h1> +{titolsH1[1][language]} </h1> <h2> -MSc Photonics a UPC </h2>{" "}
        <h2> -MBA a ESADE </h2> <h2> -MA Computer Animation a ESCAC </h2>{" "}
        <h2> -BSc Computer Graphics a UAB </h2>{" "}
        <h2> +{titolsH2[4][language]} </h2>{" "}
        <h3> -Front - end web developer </h3>{" "}
        <h4> --Certificació Tecnocampus </h4> <h3> -Machine Learning </h3>{" "}
        <h4> --Certificació Coursera / Stanford </h4>{" "}
        <h3> -ITIL Essentials </h3> <h4> --Certificació EXIN </h4>{" "}
        <h3> -Project Manager </h3> <h4> --Certificació PMI </h4>{" "}
        <h3> -Softimage 3 D </h3> <h4> --Certificació Softimage 101 - 501 </h4>{" "}
        <h3> -Avid DS </h3> <h4> --Certificació Avid DS 101 - 501 </h4>{" "}
      </section>{" "}
      <section>
        ...
        <a
          ...
          rel="noreferrer"
        >
          <h4> 3 D - AVCom Training School.EU COST Action.2015 Lisbon </h4>{" "}
        </a>{" "}
        <a
        ...
        >
          <h4>
            {" "}
            3 D - ConTourNet Training School.EU COST Action.2013 Sundsvall{" "}
          </h4>{" "}
        </a>{" "}
      </section>{" "}
      <section>
        <h1> +{titolsH1[2][language]} </h1> <h2> -SIGGRAPH </h2>{" "}
        <h2> -COEIC </h2> <h2> -VRARA </h2> <h2> -MENSA </h2>{" "}
      </section>{" "}
      <section>
        <h1> +{titolsH1[3][language]} </h1> <h2> -{llengues[0][language]} </h2>{" "}
        <h3> --Idioma Matern </h3> <h3> --Certificació C1 </h3>{" "}
        <h2> -{llengues[1][language]} </h2> <h3> --Idioma Matern </h3>{" "}
        <h2> -{llengues[2][language]} </h2> <h3> --Nivell negociació </h3>{" "}
        <h3> --Michigan Proficiency </h3> <h2> -{llengues[3][language]} </h2>{" "}
        <h3> --Estudiat durant 7 anys a l 'escola</h3>{" "}
        <h3> --Cal refrescar - lo </h3> <h2> -{llengues[4][language]} </h2>{" "}
        <h3> --Principiant </h3>{" "}
        <h3> --Estudiat fins 2 on curs a l 'EOI Barcelona-Drassanes</h3>{" "}
        <h2> -{llengues[5][language]} </h2> <h3> --Principiant </h3>{" "}
        <h3> --Curs online d 'iniciació</h3> <h2> -{llengues[6][language]} </h2>{" "}
        <h3> --Principiant </h3> <h3> --Curs online d 'iniciació</h3>{" "}
        <h2> -{llengues[7][language]} </h2> <h3> --Principiant </h3>{" "}
        <h3> --Curs online d 'iniciació</h3> <h2> -{llengues[8][language]} </h2>{" "}
        <h3> --Principiant </h3> <h3> --Curs online d 'iniciació</h3>{" "}
        <h3> --Classes particulars </h3>{" "}
      </section>{" "}
      <section>
        <h2> +{titolsH2[5][language]} </h2> <h3> -Tennis </h3>{" "}
        <h4> --3 ª Categoria Grup 8 </h4> <h3> -Tennis taula </h3>{" "}
        <h4> --3 ª Categoria </h4> <h3> -Golf </h3> <h4> --Handicap 19.9 </h4>{" "}
        <h3> -Esquí </h3> <h3> -Trekking </h3> <h3> -Beat Saber </h3>{" "}
        <h4> --Nivell Expert </h4> <h3> -Guitarra </h3>{" "}
        <h4> --Crusos online </h4> <h3> -Piano </h3>{" "}
        <h4> --4 rt de Solfeig </h4> <h3> -Lectura </h3>{" "}
        <h4> --Darrer llibre: 01 / 2022 A Thousand Minds </h4>{" "}
        <h3> -Cinema </h3> <h4> --Veig totes les pelis en 3 D i d 'altres</h4>{" "}
